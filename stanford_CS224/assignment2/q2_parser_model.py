...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        embeddings = tf.nn.embedding_lookup(pretrained_embeddings,
                                            self.input_placeholder)
    ...
    def add_prediction_op(self):
        ...
        W = tf.get_variable(
            "W",
            shape=(self.config.n_features * self.config.embed_size,
        ...
        b1 = tf.get_variable(
            "b1", shape=(self.config.hidden_size, ),
            initializer=tf.zeros_initializer()
        )
        b2 = tf.get_variable(
            "b2", shape=(self.config.n_classes, ),
            initializer=tf.zeros_initializer()
        )
